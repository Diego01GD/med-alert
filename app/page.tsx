    ...
    <div className="flex flex-col min-h-screen bg-linear-to-tr from-sky-400 to-slate-50">
      ...
      <nav className="flex items-center justify-between p-6 max-w-7xl mx-auto w-full">
        ...
        <div className="hidden md:flex gap-8 text-sm font-medium">
          <Link href="#features" className="hover:text-sky-700 transition-colors">Funcionalidades</Link>
          <Link href="#security" className="hover:text-sky-700 transition-colors">Seguridad</Link>
        </div>
        <Button asChild className="bg-[#A8D8FF] text-black hover:bg-[#8ec7f5] rounded-full px-6">
      ...
      <main className="flex-1">
        <section className="px-6 py-16 md:py-24 text-center max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-slate-900 mb-6">
            La forma más inteligente de <span className="text-[#28B4C6]">cuidar tu salud</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/auth/sign-up">
              <Button size="lg" className="bg-[#28B4C6] hover:bg-[#2198a8] text-white rounded-2xl px-8 py-7 text-lg shadow-lg">
                Crear mi cuenta
              </Button>
            </Link>
            <Button size="lg" variant="outline" className="border-slate-300 rounded-2xl px-8 py-7 text-lg bg-white/50 backdrop-blur-sm">
              Saber más
            </Button>
          </div>
        </section>
        ...
        {/* Features Grid */}
        <section id="features" className="px-6 py-20 bg-white/30 backdrop-blur-md">
        ...
        <section id="security" className="px-6 py-20 text-center">
          <div className="max-w-2xl mx-auto">
            <h2 className="text-3xl font-bold mb-6">Privacidad de grado médico</h2>
            <p className="text-slate-600">
              Tus datos están protegidos con cifrado de extremo a extremo. Solo tú, 
              tus familiares autorizados y tu médico verificado tienen acceso a tu historial.
            </p>
          </div>
        </section>
      </main>
